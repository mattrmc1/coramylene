	...
	<div className="container">
		<div className="row">
			<div className="col-md-9">
				...
				<p><strong>Once that is done:</strong></p>
				<p>I will get back to you  to set up the appointment date(s) that would work for both of us. Once we agree on a date/dates, I will send you a PayPal invoice for the $100 non-refundable deposit payable by debit or credit card. I do not take cash for deposits. Until the deposit is received, your appointment is not guaranteed or held. Once the date and deposit is set up, I will let you know if I feel an in-person consultation is needed. I only book consultations with those that I need more clarification from, and most of the time corresponding via email about the tattoo concept/design works just as well and saves you a trip!</p>
				<p>For additional info, please visit my <Link to="/faq" className="text-link">FAQ</Link> page. </p>
			</div>
